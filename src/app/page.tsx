...
export default function Home() {
  return (
    <>
      {/* ── Navbar ── */}
      <header className="absolute top-0 left-0 right-0 z-50 bg-primary/95 nav-glass border-b border-white/10">
      ...
      <main className="flex-grow">
        {/* ── Hero Section ── */}
        <section className="relative pt-36 md:pt-44 pb-24 md:pb-32 px-margin-mobile md:px-margin-desktop overflow-hidden">
          ...
          <div className="max-w-container-max mx-auto relative z-10 grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            <div className="md:col-span-7 flex flex-col gap-6">
              ...
              <ScrollReveal animation="fade-right" delay={200} duration={800} className="flex flex-col gap-4">
                <span className="inline-flex items-center gap-2 text-primary font-label-sm text-label-sm uppercase tracking-wider bg-primary/10 px-3 py-1 rounded-full w-max">
                  <span className="material-symbols-outlined text-sm" style={{ fontVariationSettings: '"FILL" 1' }}>verified</span>
                  Sinergi Keahlian Bisnis & Teknologi Terkini
                </span>
                <h1 className="text-display-lg-mobile md:text-display-lg font-display-lg text-on-background text-balance font-bold leading-tight">
                ...
                <div className="flex flex-wrap gap-4 mt-4">
                  <a href="https://wa.me/6285214120235?text=Halo%20LimoriaTech%2C%20saya%20ingin%20berkonsultasi%20mengenai%20solusi%20bisnis%20dan%20teknologi%20untuk%20perusahaan%20saya." target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-primary text-on-primary px-8 py-3 rounded-lg text-label-md font-label-md hover:bg-primary/90 transition-all shadow-sm hover:shadow-lg active:scale-[0.98]">
                    Konsultasi Sekarang
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
              <StaggerReveal animation="fade-up" baseDelay={100} stagger={150}>
                ...
                <div className="bg-surface-container-low rounded-2xl p-8 border border-surface-variant hover:border-primary/50 hover:shadow-xl transition-all duration-300 group flex flex-col h-full shadow-sm">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 overflow-hidden group-hover:bg-primary transition-colors duration-300">
                    <span className="material-symbols-outlined text-primary text-3xl group-hover:text-white transition-colors duration-300">receipt_long</span>
                  </div>
                ...
                <div className="bg-surface-container-low rounded-2xl p-8 border border-surface-variant hover:border-primary/50 hover:shadow-xl transition-all duration-300 group flex flex-col h-full shadow-sm">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 overflow-hidden group-hover:bg-primary transition-colors duration-300">
                    <span className="material-symbols-outlined text-primary text-3xl group-hover:text-white transition-colors duration-300">account_balance</span>
                  </div>
                ...
                <div className="bg-surface-container-low rounded-2xl p-8 border border-surface-variant hover:border-primary/50 hover:shadow-xl transition-all duration-300 group flex flex-col h-full shadow-sm">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 overflow-hidden group-hover:bg-primary transition-colors duration-300">
                    <span className="material-symbols-outlined text-primary text-3xl group-hover:text-white transition-colors duration-300">devices</span>
                  </div>
        ...
        {/* ── Commitment Section ── */}
        <section id="tentang" className="py-20 md:py-28 px-margin-mobile md:px-margin-desktop bg-surface-container-low">
          <div className="max-w-container-max mx-auto">
            <div className="bg-white rounded-2xl p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 md:gap-16 shadow-sm border border-surface-variant overflow-hidden">
        ...
        {/* ── Contact Us Section ── */}
        <section id="kontak" className="py-20 md:py-28 px-margin-mobile md:px-margin-desktop bg-on-background text-white">
          <div className="max-w-container-max mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
              <ScrollReveal animation="fade-right" duration={800} className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-lg">
      ...
      {/* ── Footer ── */}
      <footer className="w-full py-12 md:py-16 px-margin-mobile md:px-margin-desktop bg-surface border-t border-surface-variant">
